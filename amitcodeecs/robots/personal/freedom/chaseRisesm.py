...
def chaseRisesm(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HB5Y&action=guest&cellCode=TKV&combo=Y&flowVersion=REACT&AOC=6670&RPC=0540&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        # write_delay(
        #     driver, 
        #     '//*[@id="RadioGroup-applicant.higherEducationEnrollmentStatusIndicator-input-1"]', 
        #     False
        # )
        ...
        select_element = driver.find_element(
            by=By.XPATH, 
            value='//*[@id="RadioGroup-applicant.higherEducationEnrollmentStatusIndicator"]'
        )
        driver.execute_script("arguments[0].setAttribute('selected-radio',arguments[1])",select_element, 'false')
        # random_sleep(1)
        ...
        # I Agree
        try:
            driver.execute_script('document.querySelector("#root > div > div.mds-container-fluid.mds-px-at-768-0.containerLock > div > div.mds-col-at-576-8.mds-col-at-768-8.mds-col-at-992-6.mds-col-12.mds-mt-4 > main > form > div > div:nth-child(19) > mds-fieldset").querySelector("div> div> div> mds-checkbox").shadowRoot.querySelector("div>div").click()' )
            # send_click(driver, '//*[@id="skipAppCap.consumerCertificationsAgreement-checkbox-0"]')
        except:
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Freedom Risesm Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Freedom Risesm Credit Card"
        ...
        try:
            ...
            flag = 1
            filepath = ""
        # product_id = '66864f8251faeba61310e551'    

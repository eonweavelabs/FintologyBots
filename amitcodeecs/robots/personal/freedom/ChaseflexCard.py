...
def ChaseFreedomFlex(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H58B&action=guest&cellCode=61DS&combo=Y&flowVersion=REACT&AOC=6662&RPC=0534&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Freedom Flex Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Freedom Flex Card"

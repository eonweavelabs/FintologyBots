...
def freedomUnlimitedCreditCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H58Y&action=guest&cellCode=61DS&combo=Y&flowVersion=REACT&AOC=6610&RPC=0509&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        # send_click(
        #     driver, 
        #     '//*[@id="applicant.address.0-addressStateCode"]'
        # )
        random_sleep(2)
        retry_count = 0
        ...
        # send_click(
        #     driver,
        #     '//*[@id="applicant-residenceOwnershipSelect"]'
        # )
        random_sleep(1)
        retry_count = 0
        while retry_count < 600:
        ...
        # send_click(
        #     driver,
        #     '//*[@id="applicant-primaryIncomeSourceSelect"]'
        # )
        random_sleep(1)
        retry_count = 0
        while retry_count < 600:
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Freedom Unlimited Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Freedom Unlimited Credit Card"

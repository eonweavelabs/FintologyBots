...
def airwaysVisaSignature(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - British Airways Visa Signature Card.png"
            )
        random_sleep(1)
        ...
        card_name = "British Airways Visa Signature Card"

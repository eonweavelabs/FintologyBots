...
def riseCredit(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get("https://apply.risecredit.com/apply/getting-started")
        random_sleep(15)
        ...
        # First Name
        write_delay(driver, '//*[@id="firstNameTextInput"]', personal.get("firstName"))
        random_sleep(1)

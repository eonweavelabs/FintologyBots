...
def lingusVisa(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Aer Lingus Visa Signature Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Aer Lingus Visa Signature Card"

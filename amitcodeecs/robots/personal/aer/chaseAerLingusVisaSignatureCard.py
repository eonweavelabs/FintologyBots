...
def ChaseLingusVisa(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H84Q&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=6659&RPC=0526&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Aer Lingus Visa Signature Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Aer Lingus Visa Signature Card"

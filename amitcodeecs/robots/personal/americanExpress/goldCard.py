...
def goldCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/gold-card/25330-10-0?pmccode=784&intlink=US-Axp-Shop-Consumer-PDP-GoldCard-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,

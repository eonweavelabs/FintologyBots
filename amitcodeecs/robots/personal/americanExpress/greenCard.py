...
def greenCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/american-express-green-card/25330-10-0?pmccode=145&intlink=US-Axp-Shop-Consumer-PDP-Green-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        # Agree and contunie
        send_click(driver, '//*[@id="consent-checkbox-text"]')
        random_sleep(10)
        ...
        card_name = "American Express Green Card"

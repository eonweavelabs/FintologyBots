...
def altitudeReserveVisaInfinite(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://onboarding.usbank.com/consumer/cards/H65BMW41X1/18569/84279/start?partnerId=20002&bankerId=135cam"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Us Bank Altitude Reserve Visa Infinite Card"

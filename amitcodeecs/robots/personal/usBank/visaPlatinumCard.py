...
def visaPlatinumCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://onboarding.usbank.com/consumer/cards/8HWD72678Q/8069/86775/start?partnerId=20002&bankerId=100usb"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Us Bank Visa Platinum Card"

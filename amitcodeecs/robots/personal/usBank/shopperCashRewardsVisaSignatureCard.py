...
# -----------------------------------------------------------------
# Us Bank Shopper Cash Rewards Visa Signature Card
# -----------------------------------------------------------------

def shopperCashRewardsVisaSignatureCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://onboarding.usbank.com/consumer/cards/32VH7G6DBG/8069/43683/start"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Us Bank Shopper Cash Rewards Visa Signature Card"

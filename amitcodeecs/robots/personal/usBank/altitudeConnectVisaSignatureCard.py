...
def altitudeConnectVisaSignatureCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://onboarding.usbank.com/consumer/cards/8BB5BD89H1/18569/87106/start"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Us Bank Altitude Connect Visa Signature Card"

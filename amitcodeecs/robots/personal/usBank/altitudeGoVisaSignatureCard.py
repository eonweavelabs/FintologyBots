...
def altitudeGoVisaSignatureCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://onboarding.usbank.com/consumer/cards/HQWRM3D57Q/18569/33720/start"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Us Bank Altitude Go Visa Signature Card"

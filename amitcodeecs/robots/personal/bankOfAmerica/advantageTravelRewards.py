...
def advantageTravelRewards(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.bankofamerica.com/smallbusiness/credit-cards/products/travel-rewards-business-credit-card/"
        )
        random_sleep(2)
        send_click(
            driver,
            '//*[@id="travelRewardsWorldMasterCardForBusinessCreditCard"]'
        )
        random_sleep(15)
        ...
        card_name = "Bank Of America Advantage Travel Rewards"

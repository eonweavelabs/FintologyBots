...
def ChasevisaCard(driver,data, product_id):
    try:
        #data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H8TQ&cellCode=608V11&CMID=99110016&action=guest#/origination/cardDetails/index/initiateConFullApp;cellCode=608V11;cfgCode=CONPREFILLAPPCC_DISV3;channel=C30;sourceCode=H8TQ;AOC=6272;RPC=0474;combo=N;params=,,,no,no"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Disney Visa Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Disney Visa Card"

...
def aadvantagePlatinum(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&ID=3001&HKOP=5e14cd2bcc78a3e0c635137f5dd683d7dc0be24c5b907d6e25cb8eacf49732a5&J81p="
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Citi Aadvantage Platinum Select World Elite Mastercard.png"
            )
        random_sleep(1)

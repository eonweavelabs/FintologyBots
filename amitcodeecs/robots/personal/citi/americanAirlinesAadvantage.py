...
def americanAirlinesAadvantage(driver,data, product_id):
    try:
        # data = {
        ...
        #         "zipcode": 30201,
        #         "city": "Jaipur",
        #         "homeAddress": "123 rent",
        #         "motherMaidenName": "radha",
        #     }
        # }
        driver.get(
            "https://online.citi.com/US/ag/cards/application?ID=3001&HKOP=1790ff90aca749302e8702467286539100fd8c7def1a719680b688db67b78028&app=UNSOL"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} -  Citi American Airlines Aadvantage Mileup Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Citi American Airlines Aadvantage Mileup Card"

...
def strataPremier(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&HKOP=ad561bce96f91f539367c3ebc5b3a53805d95c5a480b0151b40b76df0ec13bb2&ID=3000&ProspectID=PPtE1ABS4YxeEOZmocrgSaRS3dgzk463&intc=7~7~66~1~PDP~1~CMSDefaultOffer&pid=089&afc=1C2&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Citi Strata Premier Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Citi Strata Premier Credit Card"

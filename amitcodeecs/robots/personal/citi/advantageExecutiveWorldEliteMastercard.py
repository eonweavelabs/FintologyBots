...
def advantageExecutiveWorldEliteMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&prodType=CitiCardAA&HKOP=04e9a17e947c4185fb31e902659d1615628a3d34f4040e96d553fe50f9467fce&ID=3001&ProspectID=PxVJgQDnylLlDmpjpHjv4IVAbIktBIrv&intc=7~7~66~1~PDP~1~CMSDefaultOffer&pid=093&afc=1C2&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver,
        ...
        # I Agree
        try:
            send_click(driver, '//*[@id="tNcRegular"]')
        except:
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} -  Citi Advantage Executive World Elite Mastercard.png"
            )
        random_sleep(1)
        
        # Submit button
        send_click(driver, '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application/cds-row/div/cds-column[2]/div/cds-row/div/div[2]/form/div[8]/button')
        ...
        card_name = "Citi Advantage Executive World Elite Mastercard"

...
# ------------------------------------------------------------------
# Citi At And T Points Plus Card From Citi
# ------------------------------------------------------------------

def atAndTPointsPlus(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&HKOP=0f204dd3d9229885a1a2285ae2389fe4d7823fb5ffe928be7e6541de0d51c699&ID=3290&ProspectID=P4Pcb3pjA4rrpSismO0Wf6OXYcsIPepj&intc=7~7~66~1~PDP~1~CMSDefaultOffer&pid=458&afc=1D5&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver, 
       ...
       # First Name
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Citi At And T Points Plus Card From Citi.png"
            )
        random_sleep(1)
        ...
        card_name = "Citi At And T Points Plus Card From Citi"

...
def citiSimplicity(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&HKOP=9da247c03c038dff54db6c5db6958caa7c9374d962619910a94373532321f2db&ID=3018&ProspectID=PgM2f2rSb0OzEUGvEi0GNbKHuiUPPkE6&intc=7~7~66~1~PDP~1~CMSDefaultOffer&pid=202&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver,
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Citi Simplicity.png"
            )
        random_sleep(1)

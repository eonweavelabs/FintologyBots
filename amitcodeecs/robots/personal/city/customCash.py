...
def customCash(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&HKOP=541175b33e25f6837a0d7af4ba29114f264447b80dcde5f6be6db7d02fed5901&ID=3000&ProspectID=PRBXjuZMAiACnN1nhvoq4LnILnAGQCjy&intc=7~7~66~1~PDP~1~CMSDefaultOffer&pid=416&afc=1D5&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver,
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - City Custom Cash Card.png"
            )
        random_sleep(1)
        ...
        card_name = "City Custom Cash Card"

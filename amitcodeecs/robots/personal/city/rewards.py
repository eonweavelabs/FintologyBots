...
# -----------------------------------------------------------------
# City Rewards Credit Card
# -----------------------------------------------------------------

def rewards(driver, data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://online.citi.com/US/ag/cards/application?app=UNSOL&HKOP=5d9c13904d8f9b6e9addcdbfb1245b9a4304445b11e7809ccbf7037ae60fc4e2&ID=3000&ProspectID=PQZ8Tk8QF4P03QVMJiiAnI6pHE85uDsp&intc=7~7~67~1~MCT~1~CMSDefaultOffer&pid=408&afc=1B7&adobe_mc=MCMID%3D83143937576011983374238790889900988858,MCAID%3DNONE"
        )
        # send_click(
        #     driver,
        ...
        while retry_count < 600:
            try:
                send_click(
                    driver,
                    '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application/cds-row/div/cds-column[2]/div/cds-row/div/div[2]/form/div[5]/cds-row/div/cds-column[3]/cds-form-field/div[2]'
                )
                random_sleep(1)
                send_click(
                    driver,
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - City Rewards Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "City Rewards Credit Card"

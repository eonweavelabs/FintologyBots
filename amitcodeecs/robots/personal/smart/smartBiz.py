...
def smartBiz(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.amazon.in/ap/signin?openid.pape.max_auth_age=0&openid.return_to=https%3A%2F%2Fsmartbiz.amazon.in%2Fhome&openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&openid.assoc_handle=amzn_rangoli_seller_in&openid.mode=checkid_setup&openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&pageId=amzn_rangoli_seller_in&openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0"
        )

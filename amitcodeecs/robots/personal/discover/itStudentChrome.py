...
def itStudentChrome(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.discovercard.com/application/website/apply?srcCde=RJRM&icmpgn=STUDCH_APPLY_TOP&_gl=1*yrejct*_gcl_au*MTE4NjY1OTY0OC4xNzI0NzU2ODU0*_ga*NTE4Nzk3NTUuMTcyNDc1Njg1NQ..*_ga_3MJNPV4VSE*MTcyNTI3Mzk1NS4zLjEuMTcyNTI3NDQ4MC45LjAuMA.."
        )
        # send_click(
        #     driver,

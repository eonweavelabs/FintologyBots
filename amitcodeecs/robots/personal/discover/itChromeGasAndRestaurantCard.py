...
def itChromeGasAndRestaurantCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.discovercard.com/application/website/apply?adpt=mn&srcCde=GJVR&ICMPGN=ACQ_CHROME_APPLY_NOW_TOP_BTN"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Discover It Chrome Gas And Restaurant Card"

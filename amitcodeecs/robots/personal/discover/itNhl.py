...
# -----------------------------------------------------------------
# Discover It Nhl Credit Card
# -----------------------------------------------------------------

def itNhl(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.discovercard.com/application/website/apply?adpt=mn&srcCde=GJVV&ICMPGN=ACQ_NHL_APPLY_NOW_TOP_BTN&_gl=1*i0ahrf*_gcl_au*MTE4NjY1OTY0OC4xNzI0NzU2ODU0*_ga*NTE4Nzk3NTUuMTcyNDc1Njg1NQ..*_ga_3MJNPV4VSE*MTcyNTI3Mzk1NS4zLjAuMTcyNTI3Mzk1NS42MC4wLjA."
        )
        # send_click(
        #     driver,
        ...
        card_name = "Discover It Nhl Credit Card"

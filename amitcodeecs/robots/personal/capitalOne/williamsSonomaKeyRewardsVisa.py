...
def williamsSonomaKeyRewardsVisa(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=WILLIAMSSONOMACB&marketingChannelCode=UNS"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Williams Sonoma Key Rewards Visa"

...
# -----------------------------------------------------------------
# Capital One Venture One Rewards For Good Credit
# -----------------------------------------------------------------

def ventureOneRewardsForGoodCredit(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=29579"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Venture One Rewards For Good Credit"

...
# -----------------------------------------------------------------
# Capital One Savor One Rewards Card
# -----------------------------------------------------------------

def savorOneRewardsCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=30978"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Savor One Rewards Card"

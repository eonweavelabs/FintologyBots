...
# -----------------------------------------------------------------
# Capital One Cabela Club Card
# -----------------------------------------------------------------

def cabelaClubCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=CABELAS&marketingChannelCode=UNS&storeId=711"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Cabela Club Card"

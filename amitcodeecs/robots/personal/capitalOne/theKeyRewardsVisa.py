...
# -----------------------------------------------------------------
# Capital One The Key Rewards Visa
# -----------------------------------------------------------------

def theKeyRewardsVisa(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=KEYREWARDSWSICB&marketingChannelCode=UNS"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One The Key Rewards Visa"

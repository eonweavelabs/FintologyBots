...
# -----------------------------------------------------------------
# Capital One Bass Pro Shops Club Card
# -----------------------------------------------------------------

def bassProShopsClubCard(driver,data, product_id):
    try:
        #data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=BASSPRO&marketingChannelCode=UNS&storeId=701"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Bass Pro Shops Club Card"

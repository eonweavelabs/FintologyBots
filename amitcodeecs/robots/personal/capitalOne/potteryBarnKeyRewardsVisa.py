...
# -----------------------------------------------------------------
# Capital One Pottery Barn Key Rewards Visa
# -----------------------------------------------------------------

def potteryBarnKeyRewardsVisa(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=POTTERYBARNCB&marketingChannelCode=UNS"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Pottery Barn Key Rewards Visa"

...
# -----------------------------------------------------------------
# Capital One West Elm Key Rewards Visa
# -----------------------------------------------------------------

def westElmKeyRewardsVisa(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=WESTELMCB&marketingChannelCode=UNS"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One West Elm Key Rewards Visa"

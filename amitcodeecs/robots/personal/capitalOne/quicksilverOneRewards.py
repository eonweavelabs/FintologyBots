...
# -----------------------------------------------------------------
# Capital One Quicksilver One Rewards
# -----------------------------------------------------------------

def quicksilverOneRewards(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=29607"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Quicksilver One Rewards"

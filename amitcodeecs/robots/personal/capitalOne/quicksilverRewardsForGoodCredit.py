...
def quicksilverRewardsForGoodCredit(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=29580"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Quicksilver Rewards For Good Credit"

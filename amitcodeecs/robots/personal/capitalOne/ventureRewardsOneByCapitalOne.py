...
# -----------------------------------------------------------------
# Venture Rewards One By Capital One
# -----------------------------------------------------------------

def ventureRewardsOneByCapitalOne(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=30769"
        )
        # send_click(
        #     driver, 
        ...
        send_click(
            driver, 
            '//*[@id="personal-information-section"]/div[2]/div/div/div[2]/div/fieldset[1]/div[1]/label'
        )
        ...
        send_click(
            driver, 
            '//*[@id="personal-information-section"]/div[2]/div/div/div[2]/div/fieldset[2]/div[2]/label'
        )
        random_sleep(1)
        ...
        send_click(
            driver, 
            '//*[@id="additional-information-section"]/div[2]/div/div[1]/div/label'
        )
        ...
        send_click(
            driver, 
            '//*[@id="root"]/div/form/div[2]/div/div/div[2]/div[2]/div/button'
        )
        ...
        send_click(
            driver, 
            '//*[@id="AdditionalAcknowledgements"]/div[2]/div[2]/button'
        )
        ...
        card_name = "Venture Rewards One By Capital One"

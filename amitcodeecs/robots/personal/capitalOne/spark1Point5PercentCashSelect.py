...
# -----------------------------------------------------------------
# Capital One Spark 1 Point 5 Percent Cash Select
# -----------------------------------------------------------------

def capitalOneSpark1Point5PercentCashSelect(driver, data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=31030"
        )
        random_sleep(15)
        ...
        card_name = "Capital One Spark 1 Point 5 Percent Cash Select"

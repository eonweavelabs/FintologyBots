...
# -----------------------------------------------------------------
# Capital One Savor One Rewards For Good Credit
# -----------------------------------------------------------------

def savorOneRewardsForGoodCredit(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?productId=29581"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Capital One Savor One Rewards For Good Credit"

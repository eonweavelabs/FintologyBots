...
def rewardsPlusCreditCard(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Southwest Rapid Rewards Plus Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Southwest Rapid Rewards Plus Credit Card"

...
def rapidPlus(driver,data, product_id):
    try:
        # data = {
        #     "personal": {
        #         "firstName": "Test",
        ...
        # }
        driver.get(
            "https://creditcards.chase.com/a1/southwest/AEP50kPlus624?REF=FULLSITE&CELL=6PNF")
        send_click(
        ...
        random_sleep(1)
        write_delay(
            driver, '//*[@id="blx-nameBlock-firstName-text-validate-input-field"]', firstName)
        random_sleep(1)
        if len(middleName):
            write_delay(

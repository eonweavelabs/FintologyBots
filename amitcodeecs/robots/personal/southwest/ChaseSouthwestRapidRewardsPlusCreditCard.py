...
def ChaserewardsPlusCreditCard(driver,data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HKX3&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=1868&RPC=0458&cfgCode=FULLAPPCONCC&channel=C30#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Southwest Rapid Rewards Plus Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Southwest Rapid Rewards Plus Credit Card"

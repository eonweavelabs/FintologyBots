...
def ChaserapidPremier(driver, data, product_id):
    try:
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Southwest Rapid Rewards Premier Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Southwest Rapid Rewards Premier Credit Card"

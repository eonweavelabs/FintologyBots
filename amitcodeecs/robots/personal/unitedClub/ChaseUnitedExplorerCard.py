...
def ChaseexplorerCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H8FP&action=guest&cellCode=TKV&combo=Y&flowVersion=REACT&AOC=5058&RPC=0480&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase United Explorer Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase United Explorer Card"

...
# ------------------------------------------------------
# Chase United Questsm Card
# ------------------------------------------------------

def ChaseUnitedQuestsmCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H7XR&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=5058&RPC=0278&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase United Questsm Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase United Questsm Card"

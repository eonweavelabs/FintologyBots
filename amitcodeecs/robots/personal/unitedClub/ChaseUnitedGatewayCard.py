...
def chaseGatewayCard(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H8DV&action=guest&cellCode=TKV&combo=Y&flowVersion=REACT&AOC=6388&RPC=0261&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase United Gateway Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase United Gateway Card"

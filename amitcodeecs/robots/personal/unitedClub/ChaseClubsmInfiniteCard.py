...
# ------------------------------------------------------
# Chase United Clubsm Infinite Card
# ------------------------------------------------------

def ChaseUnitedClubsmInfiniteCard(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase United Clubsm Infinite Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase United Clubsm Infinite Card"

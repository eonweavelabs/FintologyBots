...
def ChaseUnitedCard(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase United Quest Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase United Quest Card"

...
def reserve(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HJH5&action=guest&cellCode=TKV&combo=Y&flowVersion=REACT&AOC=6653&RPC=0518&cfgCode=FULLAPPCONCC#/origination/cardDetails/index/initiateConFullApp"
        )
        # send_click(
        #     driver, 
        ...
        card_name = "Chase Sapphire Reserve Credit Card"

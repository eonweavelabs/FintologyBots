...
def cashMagnetCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/american-express-cash-magnet-card/25330-10-0?pmccode=1084&intlink=US-Axp-Shop-Consumer-PDP-CashMagnet-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Cash Magnet Card"

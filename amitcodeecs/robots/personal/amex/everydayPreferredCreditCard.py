...
def everydayPreferredCreditCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/amex-everyday-preferred-credit-card/25330-10-0?pmccode=936&intlink=US-Axp-Shop-Consumer-PDP-AEDP-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Everyday Preferred Credit Card"

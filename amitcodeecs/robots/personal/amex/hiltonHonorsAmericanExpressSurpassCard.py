...
# -----------------------------------------------------------------
# Amex Hilton Honors American Express Surpass Card
# -----------------------------------------------------------------

def hiltonHonorsAmericanExpressSurpassCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/partner/personal-card/hil/hilton-honors-surpass-credit-card/ep-hscc-8221?cid=OH%2CMB%2CCCreditCardsLPCobrandSurpassAcqBAU32024%2CMultiBR%2CTile%2CHome%2CSingleLink%2Ci83219&adobe_mc=88477666958424621893708723259555320150&adobe_mc=88477666958424621893708723259555320150#/"
        )
        # send_click(
        #     driver,
        ...
        while retry_count < 600:
            try:
                ...
                select = Select(select_element)
                select.select_by_value("EMPLOYMENT")
                break
            except:
                driver.execute_script("window.scrollBy(0,5)")
                random_sleep(0.1)
        ...
        # Continue button
        send_click(driver, '//*[@id="mainContent"]/div/div[1]/div[3]/div[1]/div[1]/div/dls-cps-personal-info-form/div/div/div[2]/react-prospect-application/div/form/div/div/div[3]/div/div/div/button')
        random_sleep(2)
        ...
        card_name = "Amex Hilton Honors American Express Surpass Card"

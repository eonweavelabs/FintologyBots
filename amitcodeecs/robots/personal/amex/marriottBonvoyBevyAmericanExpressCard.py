...
# -----------------------------------------------------------------
# Amex Marriott Bonvoy Bevy American Express Card 
# -----------------------------------------------------------------

def marriottBonvoyBevyAmericanExpressCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/marriott-bonvoy-bevy-card/25330-10-0?pmccode=1222&intlink=US-Axp-Shop-Consumer-PDP-MarriottBonvoyBevy-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Marriott Bonvoy Bevy American Express Card "

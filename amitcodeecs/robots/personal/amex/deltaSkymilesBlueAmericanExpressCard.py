...
# -----------------------------------------------------------------
# Amex Delta Skymiles Blue American Express Card
# -----------------------------------------------------------------

def deltaSkymileBlueAmericanExpressCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-blue-american-express-card/25330-10-0?pmccode=105&intlink=US-Axp-Shop-Consumer-PDP-DeltaBlue-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Delta Skymiles Blue American Express Card"

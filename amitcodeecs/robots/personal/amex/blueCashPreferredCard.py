...
def blueCashPreferredCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/blue-cash-preferred-credit-card/25330-10-0?pmccode=796&intlink=US-Axp-Shop-Consumer-PDP-BCP-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Blue Cash Preferred Card"

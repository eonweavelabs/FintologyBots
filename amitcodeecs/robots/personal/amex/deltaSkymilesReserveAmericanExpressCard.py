...
# -----------------------------------------------------------------
# Amex Delta Skymiles Reserve American Express Card
# -----------------------------------------------------------------

def deltaSkymilesReserveAmericanExpressCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-reserve-american-express-card/25330-10-0?pmccode=106&intlink=US-Axp-Shop-Consumer-PDP-DeltaReserve-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Delta Skymiles Reserve American Express Card"

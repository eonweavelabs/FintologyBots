...
# -----------------------------------------------------------------
# Amex Marriott Bonvoy Brilliant American Express Card 
# -----------------------------------------------------------------

def marriottBonvoyBrilliantAmericanExpressCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/marriott-bonvoy-brilliant-card/25330-10-0?pmccode=1150&intlink=US-Axp-Shop-Consumer-PDP-MarriottBonvoyBrilliant-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Marriott Bonvoy Brilliant American Express Card "

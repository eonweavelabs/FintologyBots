...
# -----------------------------------------------------------------
# Amex Blue Everyday Card
# -----------------------------------------------------------------

def blueEverydayCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/blue-cash-everyday-credit-card/25330-10-0?pmccode=795&intlink=US-Axp-Shop-Consumer-PDP-BCE-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        # Agree and contunie
        send_click(driver, '//*[@id="paperless-checkbox"]')
        random_sleep(10)
        ...
        card_name = "Amex Blue Everyday Card"

...
# -----------------------------------------------------------------
# Amex Delta Skymiles Platinum American Express Card
# -----------------------------------------------------------------

def deltaSkymilesPlatinumAmericanExpressCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-platinum-american-express-card/25330-64-0?pmccode=142&intlink=US-Axp-Shop-Consumer-PDP-DeltaPlatinum-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Delta Skymiles Platinum American Express Card"

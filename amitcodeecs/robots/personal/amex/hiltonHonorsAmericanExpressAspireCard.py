...
# -----------------------------------------------------------------
# Amex Hilton Honors American Express Aspire Card
# -----------------------------------------------------------------

def hiltonHonorsAmericanExpressAspireCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/hilton-honors-aspire-credit-card/25330-10-0?pmccode=1130&intlink=US-Axp-Shop-Consumer-PDP-HiltonAspire-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex Hilton Honors American Express Aspire Card"

...
def everydayCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/amex-everyday-credit-card/25330-10-0?pmccode=937&intlink=US-Axp-Shop-Consumer-PDP-AED-Prospect-ApplyNow-SideRail#/"
        )
        # send_click(
        #     driver,
        ...
        # Submit
        send_click(driver, '//*[@id="content"]/div/div/div[2]')
        ...
        card_name = "Amex Everyday Credit Card"

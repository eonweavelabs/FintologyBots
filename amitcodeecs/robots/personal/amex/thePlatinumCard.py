...
def thePlatinumCard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/platinum-card/25330-10-0?pmccode=137&intlink=US-Axp-Shop-Consumer-PDP-Platinum-Prospect-ApplyNow-Intro#/"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Amex The Platinum Card"

...
# -----------------------------------------------------------------
# Barclays Princess Rewards Visa Card
# -----------------------------------------------------------------

def BarclaysPrincessRewardsVisaCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/banking/offer-expired/?-680896151"
        )
        ...
        card_name = "Barclays Princess Rewards Visa Card"

...
# -----------------------------------------------------------------
# Barclays Rci Elite Rewards
# -----------------------------------------------------------------

def rciEliteRewards(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/5ca752d4-60cf-4e9e-824b-0846f14f0cd6?referrerid=PTRBABCIPXXX0724&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Rci Elite Rewards"

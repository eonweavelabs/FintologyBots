...
# -----------------------------------------------------------------
# Barclays Athleta Rewards
# -----------------------------------------------------------------

def athletaRewards(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://applyathletacard.com/banking/credit-card/athleta/mastercard-platinum/bcus-storefront/ddb9b22f-d1d3-48bb-ba1b-7de2fcf45d0f/?sitecode=BCSCDAT&referrerid=BCSCD&xsessionid=C7BAA60A2153E374E2A1D4B875BDD1AA"
        )
        ...
        card_name = "Barclays Athleta Rewards"

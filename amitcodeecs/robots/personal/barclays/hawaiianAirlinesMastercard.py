...
# -----------------------------------------------------------------
# Barclays Hawaiian Airlines Mastercard
# -----------------------------------------------------------------

def hawaiianAirlinesMastercard(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/f3110e08-6561-49a8-8531-e0b0a3e105cf?referrerid=BCSCD&xsessionid=4A2A1D88A17DCC88FBFE0B4D0151C648"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Hawaiian Airlines Mastercard"

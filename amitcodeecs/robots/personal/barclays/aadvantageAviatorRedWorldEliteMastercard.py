...
def aadvantageAviatorRed(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/f1d91d3e-6ccc-4eb6-8599-53af3e818da7?referrerid=BCSCD&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Aadvantage Aviator Red World Elite Mastercard"

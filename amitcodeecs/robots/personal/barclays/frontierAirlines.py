...
def frontierAirlinesWorldMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/53f4bf73-1035-461d-95c2-2c8f2ef448ae?referrerid=PTRBABCIPXXX0724&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Frontier Airlines World Mastercard"

...
# -----------------------------------------------------------------
# Barclays Miles And More World Elite Mastercard
# -----------------------------------------------------------------

def MilesAndMoreWorldEliteMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/91c36170-b334-434c-b093-2bbcd1d45a4c?referrerid=BCSCD&xsessionid=6197EC26045C29257FB62D51AF75FA40"
        )
        # send_click(
        #     driver,
        ...
        # membershipNumber mortage income
        random_sleep(1)
        write_delay(
            driver,
            '//*[@id="memberid"]',
        ...
        card_name = "Barclays Miles And More World Elite Mastercard"

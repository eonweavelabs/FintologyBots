...
def jetBlue(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/434e3d8c-000b-48d3-9e59-6b73d904ccc7?referrerid=BCSCD&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,

...
def barnesAndNoble(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/7e151ed1-f457-4622-b726-d9f6539204bb?referrerid=PTRBABCIPXXX0724&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Barnes And Noble"

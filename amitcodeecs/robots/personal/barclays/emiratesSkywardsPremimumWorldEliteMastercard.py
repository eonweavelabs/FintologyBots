...
# -----------------------------------------------------------------
# Barclays Emirates Skywards Premimum World Elite Mastercard
# -----------------------------------------------------------------

def emiratesSkywardsPremimum(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/e4c35c81-d092-430e-b5f8-41b224cc6714?referrerid=BCSCD&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Emirates Skywards Premimum World Elite Mastercard"

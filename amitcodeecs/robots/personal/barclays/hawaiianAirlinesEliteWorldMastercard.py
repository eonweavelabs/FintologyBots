...
# -----------------------------------------------------------------
# Barclays Hawaiian Airlines Elite World Mastercard
# -----------------------------------------------------------------

def hawaiianAirlinesEliteWorldMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/f3110e08-6561-49a8-8531-e0b0a3e105cf?referrerid=BCSCD&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Hawaiian Airlines Elite World Mastercard"

...
# -----------------------------------------------------------------
# Barclays Holland America Line Rewards Credit Card
# -----------------------------------------------------------------

def hollandAmericaLineRewards(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://cards.barclaycardus.com/credit-card/3c16b52e-601d-4ac8-a17d-9f7ea4f2fca7?referrerid=HALHPFooter&xsessionid=B34F92B755E93404F375E74CFE31909F"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Barclays Holland America Line Rewards Credit Card"

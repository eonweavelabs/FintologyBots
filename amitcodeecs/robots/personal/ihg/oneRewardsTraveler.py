...
def oneRewardsTraveler(driver,data, product_id):
    try:
        # data = {
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Ihg One Rewards Traveler Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Ihg One Rewards Traveler Credit Card"

...
def ChaseoneRewardsTraveler(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HD2F&action=guest&cellCode=6QFT&prefill-token=VTJGc2RHVmtYMTlvTm1YT29wNnlvV0JTbjJwVmpKYkUxTjc5RlowelFZSUhCMkZwblN3ZStKaExvR2RIeVdzcEt6OGdCK1NjVCsxUng1UXBGS1ZrbkNRL0ppdkRKNG9DMDdYOTJocDIzR289&partner-token=eyJraWQiOiJwcmltYXJ5MCIsImFsZyI6IlJTMjU2In0.eyJpc3MiOiJJSEciLCJhdWQiOiJKUCBNb3JnYW4gQ2hhc2UiLCJleHAiOjE3MjQ3NTQ1MDIsInN1YiI6IkNoYXNlIE9mZmVycyBBUEkifQ.qcegzKTBCeucGvmcyGBwZvuG2a9_MS3UT_p7l6cizGZK4TcQx2PFxb-XL95Nbl9HjPrMeLbPY8NGopFn4FDCceAozhWAxwYKOLwXaruZRpfdE7z6fy4wj5eJ6GiPysyuUNxR6gqAw4_XQjbBcxzRbw9K0EHTAAYZX_RsXGHRb2WekBrKdnwkEjF0Mfgs3W95bWAp8QnAjXfdr7-hNGMDJ1JUGcNsGjcQIEG6VQxPsa2ITgSR_hKwFma7jayJ-FtVb1HBFs9saBZSvjg-t1FjBnCECbD-3TzjUL4xfeJ9TUHOQqJl-S39RGS7ot9uKOBmdTbVFDxv0jrGYK85_h5-zA#/origination/cardDetails/index/initiateConFullApp;cellCode=6QFT;cfgCode=CONPREFILLAPPCC;channel=C30;sourceCode=HD2F;AOC=1185;RPC=0306;combo=Y;params=,,,no,no,,,a9aa6455-2f9d-4787-a64f-0d27f9b200e4"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Chase Ihg One Rewards Traveler Credit Card.png"
            )
        random_sleep(1)
        ...
        card_name = "Chase Ihg One Rewards Traveler Credit Card"

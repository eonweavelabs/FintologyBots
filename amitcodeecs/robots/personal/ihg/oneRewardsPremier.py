...
def oneRewardsPremier(driver,data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HJ9H&action=guest&cellCode=6QDZ&prefill-token=VTJGc2RHVmtYMTlNT0hMck5YblQvOFg4VVhhbjlyU1FtaEJveGJUSlg1dEVtSnVneW91ZkgvRUd4MmI5TWZmOGc2MU9aOFNST1A3d0pSeWtGVFBFdmRsMVZURUJ4VlFaWDcweGNxWmlpc3M9&partner-token=eyJraWQiOiJwcmltYXJ5MCIsImFsZyI6IlJTMjU2In0.eyJpc3MiOiJJSEciLCJhdWQiOiJKUCBNb3JnYW4gQ2hhc2UiLCJleHAiOjE3MjQ3NTMzMjcsInN1YiI6IkNoYXNlIE9mZmVycyBBUEkifQ.AcMb8nfw_OS8MFLkeAS6o3JV8BmuCk1hWmRozcmOgleBh4878ZGThZhTWa4mwAtzCKrt_UtjxnwnDBU68N6yL_HKu7VerGLqsz8lZiHR1kOOO-3Xc2cmHvKsf9s5ZUPUVRc8ubKiMD3ozD5fGzSluDm-yjxYOM5TLdev4l9zkTS2t2wuw4TClIclse4sqOy9GbIMwVRCMEZoDU8_FuRjvaGkeejMQVhDc1VwX3rWCci9NGi1pUodlSF2XgFTgLpeWQ9kkd6AclftSMK9li3JkoLcQmnoaX0czeB0xWfCZ0BQ77dA0-HQz0-D7EELABzdQBYP2C_fO-y98HKTVpSXkw#/origination/cardDetails/index/initiateConFullApp;cellCode=6QDZ;cfgCode=CONPREFILLAPPCC;channel=C30;sourceCode=HJ9H;AOC=1185;RPC=0529;combo=Y;params=,,,no,no,,,d734b182-adc0-4872-904c-cc1f0d291fdf"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Ihg One Rewards Premier Credit Card.png"
            )
        random_sleep(1)

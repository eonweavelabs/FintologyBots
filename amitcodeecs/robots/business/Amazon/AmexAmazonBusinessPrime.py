...
def AmexAmazonBusinessPrime(driver,data, product_id):
    try:
        #data = {
        ...
        # }
        driver.get(
            "https://identity.doordash.com/auth?client_id=1666519390426295040&intl=en-US&layout=consumer_web&prompt=none&redirect_uri=https%3A%2F%2Fwww.doordash.com%2Fpost-login%2F&response_type=code&scope=%2A&state=%2Frewards-card%2Fapply%3FCELL%3D61DS%26SPID%3DGZ55%7C%7C4ea9cf48-24ee-4d90-b8b7-5b5b44cfc1e1https://www.amazon.com/dp/B07984JN3L?plattr=45094"
        )
        # send_click(
        ...
        try:
            ...
            driver.save_screenshot(
                f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Amex Amazon Business Prime.png"
            )
        random_sleep(1)
        ...
        card_name = "Amex Amazon Business Prime"

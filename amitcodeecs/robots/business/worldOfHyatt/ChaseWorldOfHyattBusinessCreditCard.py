...
def ChaseWorldOfHyattBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=H6TJ&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=6608&RPC=0537&cfgCode=INDBIZCC&channel=C30#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase World Of Hyatt Business Credit Card"

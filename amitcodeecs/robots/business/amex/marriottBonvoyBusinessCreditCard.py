...
def amexMarriottBonvoyBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/marriott-bonvoy-business-american-express-card/45094-9-0?intlink=US-Acq-GCP-Open-CardDetail-MarriottBonvoyBusinessCard-Apply-MarriottBonvoyBusiness#/"
        )
        random_sleep(15)
        ...
        card_name = "Amex Marriott Bonvoy Business Credit Card"

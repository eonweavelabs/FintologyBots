...
# -----------------------------------------------------------------
# Amex Delta Skymiles Reserve Business Card
# -----------------------------------------------------------------

def deltaSkymilesReserveBusinessCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-reserve/45094-9-0?intlink=US-Acq-GCP-Open-CardDetail-DeltaReserveCard-Apply-DeltaSkyMilesReserve#/"
        )
        random_sleep(15)
        ...
        card_name = "Amex Delta Skymiles Reserve Business Card"

...
# -----------------------------------------------------------------
# Amex Delta Skymiles Gold Business Card
# -----------------------------------------------------------------

def deltaSkymilesGoldBusinessCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-gold/45094-9-0?intlink=US-Acq-GCP-Open-CardDetail-GoldDeltaSkymilesCard-Apply-GoldDeltaSkymiles#/"
        )
        random_sleep(15)
        ...
        card_name = "Amex Delta Skymiles Gold Business Card"

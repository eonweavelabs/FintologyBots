...
def amexBlueBusiness(driver, data, product_id):
    try:
        # data = {
        ...
        # Home Phone Number
        write_delay(driver, '//*[@id="phone-number-181"]', business.get("homePhoneNumber"))
        random_sleep(1)

        # SSN
        write_delay(driver, '//*[@id="ssn-224"]', personal.get("ssn"))
        random_sleep(1)

        # Date of Birth
        write_delay(driver, '//*[@id="date-of-birth-189"]', personal.get("dob"))
        random_sleep(1)

        # Total Annual Income
        write_delay(driver, '//*[@id="annual-income-193"]', business.get("totalAnnual"))
        random_sleep(1)
        
        # non-taxable-income
        write_delay(driver, '//*[@id="non-taxable-income-197"]', business.get("nonTaxableIncome"))
        random_sleep(1)

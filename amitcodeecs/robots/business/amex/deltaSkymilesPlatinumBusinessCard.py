...
# -----------------------------------------------------------------
# Amex Delta Skymiles Platinum Business Card
# -----------------------------------------------------------------

def deltaSkymilesPlatinumBusinessCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/delta-skymiles-platinum/45094-9-0?intlink=US-Acq-GCP-Open-CardDetail-DeltaPlatinumCard-Apply-DeltaPlatinum#/"
        )
        random_sleep(15)
        ...
        card_name = "Amex Delta Skymiles Platinum Business Card"

...
def AmexBusinessPlatinumCard(driver, data, product_id):
    try:
        # data = {
        ...
        random_sleep(15)
        send_click(driver, '//*[@id="mainContent"]/div/main-container/div[2]/div/div[2]/div[1]/div[2]/div[2]/div/div/div/span/div/button')
        random_sleep(15)
        ...
        # Home Phone Number
        write_delay(driver, '//*[@id="phone-number-222"]', business.get("homePhoneNumber"))
        random_sleep(1)
        
        # Cell Phone Number
        write_delay(driver, '//*[@id="phone-numer-218"]', personal.get("mobileNumber"))
        random_sleep(1)

        # SSN
        write_delay(driver, '//*[@id="ssn-227"]', personal.get("ssn"))
        random_sleep(1)
        ...
        card_name = "Amex Business Platinum Card"

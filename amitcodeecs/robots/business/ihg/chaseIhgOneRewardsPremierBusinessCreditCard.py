...
def chaseRewardsPremierBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        # driver.get(
        #     "https://secure.chase.com/web/oao/application/card?sourceCode=HGS9&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=1185&RPC=0314&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        # )
        driver.get("https://creditcards.chase.com/travel-credit-cards/ihg-rewards-club/premier")
        random_sleep(10)
        # driver.execute_script("window.scrollBy(0,20)")
        apply_button = driver.find_elements(By.XPATH, "//a[contains(text(), 'Apply as a guest')]")[1]
        apply_button.click()
        ...
        write_delay(
            driver,
            '//*[@id="root"]/div/div[2]/div/div[4]/main/form/div/div[4]/div[2]/mds-datepicker',
            dob
        )
        random_sleep(1)
        random_sleep(1)
        ...
        random_sleep(1)
        send_click(driver, '//*[@id="ssaDisclosure-Fieldset"]')
        random_sleep(1)
        ...
        while retry_count < 600:
            try:
                ...
                driver.execute_script(
                    "arguments[0].setAttribute('value',arguments[1])", select_element, 'OWN')
                break
            except:
                driver.execute_script("window.scrollBy(0,5)")
                random_sleep(0.1)
        ...
        while retry_count < 600:
            try:
                ...
                driver.execute_script(
                    "arguments[0].setAttribute('value',arguments[1])", select_element, 'EMPLOYED')
                break
            except:
                driver.execute_script("window.scrollBy(0,5)")
                random_sleep(0.1)
        ...
        random_sleep(1)
        send_click(driver, '//*[@id="skipAppCap.consumerCertificationsAgreement-Fieldset"]')
        ...
        card_name = "Chase Ihg One Rewards Premier Business Credit Card"

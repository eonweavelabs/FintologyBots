...
def altitudePowerWorldEliteMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://onboarding.usbank.com/usl/business/usb-credit-card/application/business-information?locationCode=18569&offerId=G2G6RQRD8P&sourceCode=43464&machineType=usbank&preparerType=customer"
        )
        ...
        card_name = "Us Bank Business Altitude Power World Elite Mastercard"

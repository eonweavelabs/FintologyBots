...
def tripleCashRewardsVisa(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://onboarding.usbank.com/usl/business/usb-credit-card/application/business-information?locationCode=8069&offerId=3P4D3XWG77&sourceCode=87719&machineType=usbank&preparerType=customer"
        )
        ...
        card_name = "Us Bank Triple Cash Rewards Visa Business Card"

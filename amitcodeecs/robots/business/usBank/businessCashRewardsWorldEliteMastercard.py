...
def UsBankBusinessCashRewardsWorldEliteMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.usbank.com/business-banking/business-credit-cards.html"
        )
        ...
        card_name = "Us Bank Business Cash Rewards World Elite Mastercard"

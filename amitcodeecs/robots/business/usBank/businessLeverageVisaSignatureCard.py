...
def businessLeverageVisaSignatureCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://onboarding.usbank.com/usl/business/usb-credit-card/application/business-information?locationCode=8069&offerId=QRR5RVRDWR&sourceCode=43741&machineType=usbank&preparerType=customer"
        )
        ...
        card_name = "Us Bank Business Leverage Visa Signature Card"

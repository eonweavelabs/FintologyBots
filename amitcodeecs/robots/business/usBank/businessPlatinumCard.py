...
def businessPlatinumCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://onboarding.usbank.com/usl/business/usb-credit-card/application/business-information?locationCode=8069&offerId=81WXV5BD11&sourceCode=87720&machineType=usbank&preparerType=customer"
        )
        ...
        card_name = "Us Bank Business Platinum Card"

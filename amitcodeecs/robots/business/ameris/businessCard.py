...
def businessCard(driver, data, product_id):
    try:
        driver.get(
            "https://creditcardlearnmore.com/11t3/202208/business-platinum?ecdma-lc=12252&ecid=OTHE_25940"
        )
        random_sleep(1)
        driver.get(
            "https://online1.elancard.com/oad/begin?locationCode=12252&offerId=6H7R5G41WM&preparerType=customer"
        )
        random_sleep(15)
        ...
        send_click(driver, "//button[@id='button.submitButton']")

        random_sleep(5)
        send_click(driver, "//button[contains(text(),'Confirm & continue')]")
        ...
        card_name = "Ameris Business Card"

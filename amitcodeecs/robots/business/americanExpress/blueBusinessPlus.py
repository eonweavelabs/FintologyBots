...
def americanExpressBlueBusinessPlus(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://www.americanexpress.com/us/credit-cards/card-application/apply/bluebusinessplus-credit-card/45094-9-0?intlink=US-Acq-GCP-Open-CardDetail-BlueBusinessPlusCard-Apply-BlueForBusinessPlus#/"
        )
        random_sleep(15)

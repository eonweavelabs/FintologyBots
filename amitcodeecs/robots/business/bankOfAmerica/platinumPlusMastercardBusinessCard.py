...
def bankOfAmericaPlatinumPlusMastercardBusinessCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get("https://www.bankofamerica.com/smallbusiness/credit-cards/products/platinum-plus-business-credit-card/")
        random_sleep(15)
        send_click(driver, '//*[@id="platinumPlusForBusinessMasterCard"]')
        random_sleep(15)
        ...
        while retry_count < 600:
            try:
                ...
                send_click(driver, '//*[@id="p0UFay5"]')
                # select_element = driver.find_element(
                #     by=By.XPATH,
                #     value='//*[@id="controlling_manager_list_v_1"]'
                # )
                # select = Select(select_element)
                # select.select_by_value('abad867a-e189-4483-8bb4-4f24ba6f4310')
                break
            except:
                driver.execute_script("window.scrollBy(0,5)")
                random_sleep(0.1)
        ...
        send_click(driver, '//*[@id="owner-1-Question1"]/fragment[1]/div/div/div[1]/div/label')
        random_sleep(1)
        send_click(driver, '//*[@id="owner-1-Question1"]/fragment[1]/div/div/div[1]/div/label')
        random_sleep(1)
        ...
        random_sleep(1)
        send_click(driver, '//*[@id="rUEYy0"]')
        random_sleep(10)
        random_sleep(10)

        # Screenshot and upload
        full_name = f"{firstName} {lastName}"
        card_name = "Bank Of America Platinum Plus Mastercard Business Card"

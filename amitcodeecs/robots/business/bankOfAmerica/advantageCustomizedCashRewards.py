...
# ----------------------------------------------------------------
# Bank Of America Advantage Customized Cash Rewards
# ----------------------------------------------------------------

def boaAdvantageCustomizedCashRewards(driver, data, product_id):
    try:
        # data = {
        #     "personal": {
        #         "firstName": "John",
        ...
        driver.get("https://www.bankofamerica.com/smallbusiness/credit-cards/products/cash-rewards-business-credit-card/")
        random_sleep(15)
        send_click(driver, '//*[@id="cashRewardsForBusinessMasterCardCreditCard"]')
        random_sleep(15)
        ...
        card_name = "Bank Of America Advantage Customized Cash Rewards"

...
# -------------------------------------------------------
# Chase United Business Credit Card
# -------------------------------------------------------

def chaseUnitedBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HGW5&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=5058&RPC=0303&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase United Business Credit Card"

...
# -------------------------------------------------------
# Chase United Business Club Card
# -------------------------------------------------------

def chaseUnitedBusinessClubCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HGWH&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=6621&RPC=0479&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase United Business Club Card"

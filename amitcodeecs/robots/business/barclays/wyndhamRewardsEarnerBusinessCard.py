...
def barclaysWyndhamRewardsEarnerBusinessCard(driver, data, product_id):
    
    try:
        driver.get("https://cards.barclaycardus.com/credit-card/130da0ea-b008-4d5c-8a29-45d200cfd379?referrerid=BCSCD&xsessionid=333F2ADD0AFAD3A08F2C7BBDCF633BA9")
        random_sleep(15)
        ...
        card_name = "Barclays Wyndham Rewards Earner Business Card"

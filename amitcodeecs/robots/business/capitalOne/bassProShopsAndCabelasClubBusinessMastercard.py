...
# -----------------------------------------------------------------
# Capital One Bass Pro Shops And Cabelas Club Business Mastercard
# -----------------------------------------------------------------

def bassProShopsAndCabelasClubBusinessMastercard(driver, data, product_id):
    try:
        # data = {
        ...
        # }
        driver.get(
            "https://applynow.capitalone.com/?brandCode=CLUBBUSINESS&marketingChannelCode=UNS"
        )
        random_sleep(15)
        ...
        # Continue
        send_click(driver, '//*[@id="root"]/div/div/main/div[3]/div/form/div/div/div[1]/button')
        random_sleep(1)
        
        # Continue = 2
        send_click(driver, '//*[@id="root"]/div/div/main/div[3]/div/form/div/div[2]/button')
        random_sleep(1)
        ...
        card_name = "Capital One Bass Pro Shops And Cabelas Club Business Mastercard"

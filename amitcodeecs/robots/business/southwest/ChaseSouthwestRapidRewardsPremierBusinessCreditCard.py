...
def ChaseRapidRewardsPremierBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HJJH&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=1868&RPC=0461&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase Southwest Rapid Rewards Premier Business Credit Card"

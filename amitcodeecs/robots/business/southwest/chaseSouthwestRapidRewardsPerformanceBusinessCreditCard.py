...
def ChaseSouthwestRapidRewardsPerformanceBusinessCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        card_name = "Chase Southwest Rapid Rewards Performance Business Credit Card"

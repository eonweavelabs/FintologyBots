...
# -----------------------------------------------------
# Citi Costco Anywhere Visa Business Card By Citi
# -----------------------------------------------------

def costcoAnywhereVisaBusinessCardByCiti(driver, data, product_id):
    try:
        #data = {
        ...
        driver.get(
            "https://online.citi.com/US/ag/cards/application?prodType=CitiCardCostco&ProspectID=Pq5dNRe0OZFsb8uR4ZBSVjgmvlJ7Q7ew&app=UNSOL&afc=1C2&adobe_mc=MCMID%3D02802470873384425531468361853807654197,MCAID%3DNONE&pid=522&HKOP=5fe0aef3d9a2dddb2a49962cf2c59f3337dbae226cfcfbb3846a12424365d2d7&ID=3000&intc=7~7~66~1~PDP~1~CMSDefaultOffer"
        )
        # random_sleep(15)
        ...
        while retry_count < 600:
            try:
                send_click(driver, '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application2/cds-row/div/cds-column/div/costco-business-card-application/form/cds-column/app-dynamic-renderer/div/app-div/div/app-div[2]/div/app-row/cds-row/div/app-column/div/cds-column/address-fields/cds-row/div/cds-column[5]/cds-form-field/div[1]/cds-dropdown2')
                random_sleep(0.1)
                send_click(driver, '//*[@id="cds-option2-29"]')
        ...
        while retry_count < 600:
            try:
                send_click(driver, '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application2/cds-row/div/cds-column/div/costco-business-card-application/form/cds-column/app-dynamic-renderer/div/app-div/div/app-div[3]/div/app-column/div/cds-column/app-business-financial-information/form/cds-row[1]/div/cds-column[2]/cds-form-field/div[1]/cds-dropdown2')
                random_sleep(0.1)
                send_click(driver, '//*[@id="cds-option2-62"]')
                # select_element = driver.find_element(
                #     by=By.XPATH,
                #     value='//*[@id="state-5AD7DD2499FEC7D4FE40852F66885FF7-button-value"]'
                # )
        ...
        while retry_count < 600:
            try:
                send_click(driver, '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application2/cds-row/div/cds-column/div/costco-business-card-application/form/cds-column/app-dynamic-renderer/div/app-div/div/app-div[4]/div/app-column/div/cds-column/app-business-other-information/form/cds-row[2]/div/cds-column[2]/cds-form-field/div[1]/cds-dropdown2')
                random_sleep(0.1)
        ...
        while retry_count < 600:
            try:
                select_element = driver.find_element(
                    by=By.XPATH, 
                    value='//*[@id="state-1A2406BD8515714B79DD2A814B5C2C40"]'
                )
                select = Select(select_element)
                select.select_by_value(state)
                break
        ...
        try:
            ...
            f"{data.get('preApproval').get('firstName')+data.get('preApproval').get('lastName')} - Citi Costco Anywhere Visa Business Card By Citi.png"
            )
        random_sleep(1)
        
        # Submit button
        send_click(driver, '//*[@id="maincontent"]/div/div/div/app-apply-credit/div/citi-simple-layout/app-apply-card-flow-resolver/div/app-card-application2/cds-row/div/cds-column/div/costco-business-card-application/form/div/button')
        retry_count = 0
        while retry_count < 600:
            try:
                driver.find_element(
        ...
        card_name = "Citi Costco Anywhere Visa Business Card By Citi"

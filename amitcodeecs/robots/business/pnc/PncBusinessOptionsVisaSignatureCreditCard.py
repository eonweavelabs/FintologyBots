...
# -----------------------------------------------------------------
# Pnc Business Options Visa Signature Credit Card
# -----------------------------------------------------------------

def PncBusinessOptionsVisaSignatureCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.apply.pnc.com/ccbv"
        )
        # send_click(
        #     driver,
        ...
        card_name = "Pnc Business Options Visa Signature Credit Card"

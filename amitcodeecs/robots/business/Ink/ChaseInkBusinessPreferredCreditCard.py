...
def ChaseInkBusinessPreferredCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HJVM&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=5686&RPC=0514&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        # send_click(
        #     driver,
        #     '//*[@id="RadioGroup-skipAppCap.DbaName-fieldset"]/div/div/div[2]'
        # )
        driver.execute_script('document.querySelector("#root > div > div.mds-container-fluid.mds-px-at-768-0.containerLock > div > div.mds-col-at-576-8.mds-col-at-768-8.mds-col-at-992-6.mds-col-12.mds-mt-4 > main > form > div > div:nth-child(17) > div:nth-child(3) > div > div > mds-fieldset").shadowRoot.querySelector("div > div > div").click()' )
        ...
        value = "1"
        driver.execute_script(
            "arguments[0].setAttribute('selected-index',arguments[1])", select_element, value)
        
        random_sleep(1)
        # Same Physical Address as Personal Address
        select_element = driver.find_element(
            by=By.XPATH,
            value='//*[@id="RadioGroup-skipAppCap.samePhysicalAsPersonalAddress"]'
        )
        ...
        # driver.execute_script('document.querySelector("#RadioGroup-skipAppCap\.samePhysicalAsPersonalAddress-fieldset > div > div > div:nth-child(1) > mds-fieldset").querySelector("div> div> div> mds-checkbox").shadowRoot.querySelector("div>div").click()')
        ...
        select_element = driver.find_element(
            by=By.XPATH,
            value='//*[@id="skipAppCap.certificationsAgreement-checkbox-0"]'
        )
        driver.execute_script(
            "arguments[0].setAttribute('state',arguments[1])", select_element, "true")
        ...
        card_name = "Chase Ink Business Preferred Credit Card"

...
def chaseInkBusinessUnlimitedCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=GY3W&action=guest&cellCode=61DS&combo=N&flowVersion=REACT&AOC=5686&RPC=0516&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase Ink Business Unlimited Credit Card"

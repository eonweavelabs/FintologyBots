...
def ChaseBusinessCashCreditCard(driver, data, product_id):
    try:
        # data = {
        ...
        driver.get(
            "https://secure.chase.com/web/oao/application/card?sourceCode=HGJC&action=guest&cellCode=6H8X&combo=N&AFFID=pngc6t7Ewoo-RKNNvxcXRMQpBNcsQDhJUA&pvid=1042dcd885554042b2ef96ce0e94f75c&flowVersion=REACT&AOC=5686&RPC=0475&cfgCode=INDBIZCC#/origination/cardDetails/index/indexBusinessCreditCard"
        )
        ...
        card_name = "Chase Ink Business Cash Credit Card"

...
# -----------------------------------------------------
# Truist Business With Cash Rewards
# -----------------------------------------------------

def truistBusinessWithCashRewards(driver, data, product_id):
    try:
        driver.get(
            "https://www.truist.com/small-business/credit-cards/business-cash-rewards"
        )
        random_sleep(15)
        
        send_click(driver, '//*[@id="cta-465170408"]/a')
        random_sleep(15)

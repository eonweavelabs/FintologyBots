...
def TruistBusinessCreditCard(driver, data, product_id):
    try:
        driver.get(
            "https://www.truist.com/small-business/credit-cards/business-card"
        )
        random_sleep(15)
        
        send_click(driver, '//*[@id="cta-1366792324"]/a')
        random_sleep(15)
        ...
        card_name = "Truist Business Credit Card"

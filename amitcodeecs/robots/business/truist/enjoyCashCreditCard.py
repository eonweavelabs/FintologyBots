...
def TruistEnjoyCashCreditCard(driver, data, product_id):
    try:
        driver.get(
            "https://www.truist.com/credit-cards/enjoy-cash"
        )
        random_sleep(15)
        
        send_click(driver, '//*[@id="cta-1521001128"]/a')
        random_sleep(15)
        ...
        card_name = "Truist Enjoy Cash Credit Card"
